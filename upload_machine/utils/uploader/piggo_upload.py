...
def piggo_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    ...
    raw_cookies = "cf_clearance=EFeDqK.AwL.6jrr3Szq8P16WD0mnX5Gw6jdtFeZw0Fw-1658382309-0-150; c_secure_uid=MTAxNzg%3D; c_secure_pass=681d0177f1633f622820ab7ef57ba076; c_secure_ssl=eWVhaA%3D%3D; c_secure_tracker_ssl=eWVhaA%3D%3D; c_secure_login=bm9wZQ%3D%3D"
    ...
    #r = requests.post(post_url, cookies=cookies_raw2jar(raw_cookies),data=other_data, files=file_tup)
